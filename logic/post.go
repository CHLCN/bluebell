...
func GetPostList2(p *models.ParamPostList) (data []*models.ApiPostDetail, err error) {
	...
	if len(ids) == 0 {
		zap.L().Warn("redis.GetPostIDsInOrder(p) success return 0 data")
		return
	}
...
func GeCommunityPostList(p *models.ParamPostList) (data []*models.ApiPostDetail, err error) {
...
func GetPostListNew(p *models.ParamPostList) (data []*models.ApiPostDetail, err error) {
	...
	if p.CommunityID == 0 {
		...
		// 根据社区id查询
		data, err = GeCommunityPostList(p)
	}
	if err != nil {
